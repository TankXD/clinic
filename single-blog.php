...
<?php $term = get_the_terms(get_the_ID(), 'blog-category');?>
    ...
    <div class="p-page-top__inner">
        ...
        <div class="p-page-top__text-wrap">
            <div class="p-page-top__title">
                <?php $post_name = "blog";
                printPostTypeLabel($post_name);
                ?>
            </div>
            <p class="p-page-top__sub-title">
                <?php 
                printPostTypeDescription($post_name);
                ?>
            </p>
        </div>
    </div>
        ...
        <section class="l-archive">
            <div class="l-archive__articles p-post">
                ...
                <div class="p-post__links">
                    ...
                    <?php endif;?>
                    <a href="<?php echo get_post_type_archive_link('blog') ?>" class="p-post__links--archive">
                        記事一覧
                    </a>
