        ...
        <div class="l-header__inner">
            ...
            <div class="l-header__right">
                <ul class="p-header-nav">
                    <li class="p-header-nav__item <?php if(is_home()){echo "active";}?>">
                        <a href="<?php echo home_url('/') ?>" class="p-header-nav__link">
                    ...
                    <li class="p-header-nav__item <?php if(is_page('about')){echo "active";}?>">
                        <a href="<?php echo getPageLink('about') ?>" class="p-header-nav__link">
                    ...
                    <li class="p-header-nav__item <?php if(is_page('medical')){echo "active";}?>">
                        <a href="<?php echo getPageLink('medical') ?>" class="p-header-nav__link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
                    ...
                    <li class="p-header-nav__item <?php if(is_page('staff')){echo "active";}?>">
                        <a href="<?php echo getPageLink('staff') ?>" class="p-header-nav__link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
                    ...
                    <li class="p-header-nav__item <?php if(is_post_type_archive('blog')){echo "active";}?>">
                        <a href="<?php echo get_post_type_archive_link('blog') ?>" class="p-header-nav__link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24"
                                fill="none">
                                <path
                                    d="M19.8998 7.3401L17.1598 4.6001C16.4195 3.90476 15.2756 3.87466 14.4998 4.5301L5.49981 13.5301C5.17658 13.8561 4.97532 14.2833 4.92981 14.7401L4.49981 18.9101C4.47254 19.2066 4.57885 19.4999 4.78981 19.7101C4.97853 19.8973 5.23401 20.0016 5.49981 20.0001H5.58981L9.75981 19.6201C10.2166 19.5746 10.6438 19.3733 10.9698 19.0501L19.9698 10.0501C20.6971 9.28177 20.6658 8.06987 19.8998 7.34011L19.8998 7.3401ZM9.57981 17.6201L6.57981 17.9001L6.84981 14.9001L12.4998 9.3201L15.1998 12.0201L9.57981 17.6201ZM16.4998 10.6801L13.8198 8.0001L15.7698 6.0001L18.4998 8.7301L16.4998 10.6801Z"
                                    fill="#393939" />
                            </svg>
                            <span>スタッフブログ</span>
                        </a>
                    </li>
                    <li class="p-header-nav__item <?php if(is_page('contact')){echo "active";}?>">
                        <a href="<?php echo get_permalink(get_page_by_path('contact')) ?>" class="p-header-nav__link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
                ...
                <div class="p-header-tel">
                    <p class="p-header-tel__text">〒166-0001 東京都杉並区阿佐谷北7-3-1</p>
                    <a href="tel:03-1234-5678" class="p-header-tel__number">
                        <img src="<?php echo get_template_directory_uri().'/img/common/tel.svg' ?>" alt="tel">
            ...
            <!-- header__drawer -->
            <button class="p-header__drawer-button" id="js-drawer-button">
                <span class="p-header__drawer-button__bar"></span>
                <span class="p-header__drawer-button__bar"></span>
                <span class="p-header__drawer-button__bar"></span>
            </button>

            <div class="p-header__drawer-menu" id="js-drawer-menu">
                <div class="p-header__drawer-list">
                    <a href="<?php echo get_template_directory_uri() ?>" class="p-header__drawer-link">
                        <img src="<?php echo get_template_directory_uri().'/img/common/icon-01.svg' ?>" alt="">
                        <span>ホーム</span>
                    </a>
                    <a href="<?php echo getPageLink('about') ?>" class="p-header__drawer-link">
                        <img src="<?php echo get_template_directory_uri().'/img/common/icon-02.svg' ?>" alt="">
                        <span>当院について</span>
                    </a>
                    <a href="<?php echo getPageLink('medical'); ?>" class="p-header__drawer-link">
                        <img src="<?php echo get_template_directory_uri().'/img/common/icon-03.svg' ?>" alt="">
                        <span>診療案内</span>
                    </a>
                    <a href="<?php echo getPageLink('staff') ?>" class="p-header__drawer-link">
                        <img src="<?php echo get_template_directory_uri().'/img/common/icon-04.svg' ?>" alt="">
                        <span>スタッフ紹介</span>
                    </a>
                    <a href="<?php echo get_post_type_archive_link('blog') ?>" class="p-header__drawer-link">
                        <img src="<?php echo get_template_directory_uri().'/img/common/icon-05.svg' ?>" alt="">
                        <span>スタッフブログ</span>
                    </a>
                    <a href="<?php echo get_permalink(get_page_by_path('clinic')) ?>" class="p-header__drawer-link">
                        <img src="<?php echo get_template_directory_uri().'/img/common/icon-06.svg' ?>" alt="">
                        <span>お問い合わせ</span>
                    </a>
                </div>
            </div>
