...
<aside class="l-archive__sidebar p-sidebar">
    ...
    <div class="p-sidebar-articles">
        ...
        <div class="p-sidebar-articles__list">
            ...
            <!-- ポストがある場合は、そのポストのサムネイルを左側に表示し、カテゴリとタイトル、日付を右側に表示する -->
    ...
    <div class="p-sidebar-category">
        ...
        <ul class="p-sidebar-category__list">
            <?php $terms = get_terms('blog-category', array('hide_empty' => false));
                            foreach($terms as $term):?>
            <li class="p-sidebar-category__item">
                <a href="<?php echo get_term_link($term, 'blog-category'); ?>" class="p-sidebar-category__link">
                    <?php echo $term->name;?>
                </a>
            </li>
            <?php endforeach;?>
